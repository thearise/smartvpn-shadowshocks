    ...
    return html`
      ...
      <app-header-layout fullbleed="">
        ...
        <iron-pages id="pages" selected="[[page]]" attr-for-selected="name">
          <servers-view style="background: white !important;" name="servers" id="serversView" servers="[[servers]]" localize="[[localize]]" use-alt-access-message="[[useAltAccessMessage]]""></servers-view>
