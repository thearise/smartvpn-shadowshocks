...
import circle from '../../../assets/orbit1.png';
import circle2 from '../../../assets/orbit2.png';
import circle3 from '../../../assets/orbit3.png';
        ...
        circleSize =>
          html`
            <img
              ...
              src="${(circleSize.toString()=='large')?circle:((circleSize.toString()=='medium')?circle3:circle2)}"
              height="100%"
              draggable="false"
            />
          `
